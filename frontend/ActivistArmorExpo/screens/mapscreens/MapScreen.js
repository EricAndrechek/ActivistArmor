...
const manual_data = [
  {
    url:
      "https://www.commondreams.org/sites/default/files/styles/cd_large/public/headlines/cops_cops.png?itok=iWwv817T",
        ...
        >
          {manual_data.map((marker, key) => (
            <Marker
              ...
              key={key}
            >
              <Callout onPress={() => this.markerClick(marker.url)}></Callout>
            </Marker>
          ))}
        </MapView>
