...
const data = [
  {
    ...
    image:
      "https://activist-armor.nyc3.cdn.digitaloceanspaces.com/a285e2bb-a79f-488a-baa4-7bafa80fae96.mp4",
    id: 1
  },
  {
    address: "London, UK",
...
function Post(input) {
  return (
    <View style={styles.post}>
      ...
      {input.postData.url.includes(".jpg") ||
      input.postData.url.includes(".png") ? (
